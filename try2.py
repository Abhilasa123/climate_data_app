...
include_parameters = ['Annual_RF_', 'TMAX_Annua','TMAX_MAM_C','TMIN_DJF_C','HWDI_per_t',
                      'JJAS_RF_Ch','OND_RF_Cha','JJAS_CDD_P','OND_CDD_Pe','JJAS_R20MM',
                      'OND_R20MM_','RX5day_JJA','Annual_Wet','MAM_Wet_Bu']
rename_mapping = {
    ...
    'JJAS_CDD_P': "Change in continuous dry days during monsoon",
    'OND_CDD_Pe': "Change in continuous dry days during retreating monsoon",
    'JJAS_R20MM': "Change in number of days with precipitation greater than 20mm during monsoon",
    'OND_R20MM_': "Change in number of days with precipitation greater than 20mm during retreating monsoon",
